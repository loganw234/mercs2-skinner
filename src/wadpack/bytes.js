// Little-endian byte helpers, shared so no two modules declare their own `u32w` (which a
// flat single-file bundle would see as a top-level collision).

export const u16w = (d, o) => d[o] | (d[o + 1] << 8);
export const u32w = (d, o) => (d[o] | (d[o + 1] << 8) | (d[o + 2] << 16) | (d[o + 3] << 24)) >>> 0;
export const putU16 = (d, o, v) => { d[o] = v & 0xff; d[o + 1] = (v >>> 8) & 0xff; };
export const putU32w = (d, o, v) => {
