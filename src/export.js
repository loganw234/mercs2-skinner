...
export function buildNotes({ bundle, plan }) {
  return [
    ...
    '',
    'NO COMMAND LINE? Drop this whole .zip into  https://wad.mercs2.tools',
    '  (the "Pack a skinner export" card) and it builds the vz-patch.wad for you —',
    '  in the browser, nothing uploaded. Same result as install.bat.',
    '',
